...
export default (props: {
  ...
  return <c-x style={{ width: "100%", flex: 1, marginTop: props.title ? 5 : 0, fontSize: 11, direction: props.direction as any, ...props.style }}>
    ...
    <div style={{ display: "flex", alignItems: "center", marginTop: props.title ? 3 : 0, flex: 1 }}>
      ...
      <textarea rows={1}
        ...
        style={{
          ...
          resize: "none", overflow: "hidden", whiteSpace: "nowrap", paddingTop: 7 + (12 - ((props.fontSize || props.style?.fontSize || 12) as number)),
        ...
        className={z.qestyles.textbox} spellCheck={false}
