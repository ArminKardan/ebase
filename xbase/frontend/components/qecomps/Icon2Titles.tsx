...
export default (props: {
  title?: any, raw1?: boolean, title1?: any, title2?: any,
  ...
  return <f-csb class={(props.nohover ? null : z.qestyles.hover) + " " + props.class}
    style={{ position: "relative", borderRadius: 4, fontSize: "inherit", height: 40, ...props.style }}
    onClick={() => props.on?.()}>
    ...
    <f-cc style={{ zIndex: 10 }}>
      ...
      {props.raw ? <c-xsb>
        ...
        {typeof props.title2 == "string" ? <Bold style={{ display: "block", fontSize: props.f2 || 11, lineHeight: 1.5, textAlign: "right" }}>{props.title2}</Bold> : props.title2}
      </c-xsb>)}
